<template>
    <div>
        ...
        <el-table :data="newss.slice((currentPage-1)*pageSize,currentPage*pageSize)" border style="width: 100%"  stripe>
            <el-table-column
                    prop="teacherName"
                    label="发布者">
            </el-table-column>
            ...
            <el-table-column
                ...
                <template #default="scope">
                    ...
                    <el-button @click="handleEdit(scope.row)"  type="warning" icon="el-icon-edit" circle>编辑</el-button>
        ...
        <div style="margin: 10px 0">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="[5]"
        ...
        methods:{
            ...
            load(){
                if (this.search === ''){
                    ...
                    this.$axios.get("/news/findNewsTea/"+this.search).then(res => {
